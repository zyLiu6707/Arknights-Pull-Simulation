...
test_case = [["./cmd_parse_unitest", "1"]
    ...
    # Test cases for -c, --current-pull
    , ["./cmd_parse_unitest -c", "0"]
    , ["./cmd_parse_unitest -c 1", "1"]
    , ["./cmd_parse_unitest -c 2", "1"]
    , ["./cmd_parse_unitest -c 2 1", "0"]
    , ["./cmd_parse_unitest -c 2.0", "0"]
    , ["./cmd_parse_unitest -c 0", "1"]
    , ["./cmd_parse_unitest -c -1", "0"]
    , ["./cmd_parse_unitest -c -1.0", "0"]
    , ["./cmd_parse_unitest -c 98", "1"]
    , ["./cmd_parse_unitest -c 99", "0"]
    , ["./cmd_parse_unitest -c 98 -p 50", "1"]
    , ["./cmd_parse_unitest -c 99 -p 50", "0"]
    , ["./cmd_parse_unitest -c 99 -p 51", "1"]
    , ["./cmd_parse_unitest -c 100 -p 51", "0"]
    , ["./cmd_parse_unitest -c 109 -p 61", "1"]
    , ["./cmd_parse_unitest -c 109 --pity 61", "1"]
    , ["./cmd_parse_unitest --current-pull 0", "1"]
    , ["./cmd_parse_unitest --current-pull 1", "1"]
    , ["./cmd_parse_unitest --current-pull 98", "1"]
    , ["./cmd_parse_unitest --current-pull 99", "0"]
    , ["./cmd_parse_unitest --current-pull -1", "0"]
    , ["./cmd_parse_unitest --current-pull 1.0", "0"]
    , ["./cmd_parse_unitest --current-pull 98 -p 50", "1"]
    , ["./cmd_parse_unitest --current-pull 99 -p 50", "0"]
    , ["./cmd_parse_unitest --current-pull 99 -p 51", "1"]
    , ["./cmd_parse_unitest --current-pull 100 -p 51", "0"]
    , ["./cmd_parse_unitest --current-pull 109 -p 61", "1"]
    , ["./cmd_parse_unitest --current-pull 109 --pity 61", "1"]

    , ["./cmd_parse_unitest --standard", "1"]
    , ["./cmd_parse_unitest --standard --standard", "0"]
    , ["./cmd_parse_unitest --standard 2", "0"]
    ...
    , ["./cmd_parse_unitest --standard -t 20", "1"]
    , ["./cmd_parse_unitest --limited -p 20", "1"]
    , ["./cmd_parse_unitest --standard -t 20 --limited", "0"]
    , ["./cmd_parse_unitest -t -p --standard --limited -p", "0"]
    , ["./cmd_parse_unitest -t -p --standard --limited --pity", "0"]
    , ["./cmd_parse_unitest -t -p --standard --pity 0.0", "0"]
